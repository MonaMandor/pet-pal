...
import 'package:pet_pal/app/core/constansts/asset_manger.dart';
import 'package:pet_pal/app/data/model/task_model.dart';
...
class HomeController extends GetxController {
  ...
  double pet_paluble(TimeOfDay myTime) => myTime.hour + myTime.minute / 60.0;
  ...
  dailyTask() {
    ...
    if (allTasks.length != 0) {
      ...
      todayTasks.sort((a, b) {
        var aT = pet_paluble(timeConvert(a!.startTime!));
        var bT = pet_paluble(timeConvert(b!.startTime!));
    ...
    Navigator.of(context).push(
      showPicker(
        ...
        onChange: (Time newTime) {
          ...
          timeController!.text = _formatTime(Time(hour: selectedTime.hour, minute: selectedTime.minute));
          update();
        },
        is24HrFormat: false,
      ),
